...
class MultiCrossAttentionBlock(nn.Module):
    def __init__(
        ...
        super(MultiCrossAttentionBlock, self).__init__()

        self._xzattn = CrossAttentionBlock(
            dim=dim,
            num_heads=num_heads,
            mlp_ratio=mlp_ratio,
            qkv_bias=qkv_bias,
        ...
        self._xyattn = CrossAttentionBlock(
            dim=dim,
            num_heads=num_heads,
            mlp_ratio=mlp_ratio,
            qkv_bias=qkv_bias,
        ...
        self._attn = CrossAttentionBlock(
            dim=dim,
            num_heads=num_heads,
            mlp_ratio=mlp_ratio,
            qkv_bias=qkv_bias,
