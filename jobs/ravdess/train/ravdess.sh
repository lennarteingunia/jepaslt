...
python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ravdess_split_0.yaml --devices cuda:0

python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ravdess_split_1.yaml --devices cuda:0

python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ravdess_split_2.yaml --devices cuda:0

python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ravdess_split_3.yaml --devices cuda:0

python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ravdess_split_4.yaml --devices cuda:0
