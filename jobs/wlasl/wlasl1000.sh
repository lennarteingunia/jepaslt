...
### Slurm Options ###
#SBATCH --job-name=jepaslt-wlasl1000
#SBATCH --time=24-0
...
python /mnt/slurm/lennart/jepaslt/slurm/rewrite_filepath_prefixes_in_csv.py --file=/mnt/data/wlasl_vjepa/train1000.csv --prefix=/mnt/data/wlasl_vjepa/train --output=/mnt/slurm/lennart/jepaslt/data/train1000.csv
python /mnt/slurm/lennart/jepaslt/slurm/rewrite_filepath_prefixes_in_csv.py --file=/mnt/data/wlasl_vjepa/val1000.csv --prefix=/mnt/data/wlasl_vjepa/val --output=/mnt/slurm/lennart/jepaslt/data/val1000.csv

# Actually run the evaluation script

python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_wlasl1000_16x8x3.yaml --devices cuda:0 cuda:1 cuda:2
...
rm /mnt/slurm/lennart/jepaslt/data/train1000.csv
rm /mnt/slurm/lennart/jepaslt/data/val1000.csv
