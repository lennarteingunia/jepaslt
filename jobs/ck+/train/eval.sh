...
CUDA_VISIBLE_DEVICES=0,1,2 PYTHONPATH=$PYTHONPATH:/mnt/slurm/lennart/jepaslt/src python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ckplus_split_0_16x8x3.yaml --devices cuda:0 cuda:1 cuda:2
CUDA_VISIBLE_DEVICES=0,1,2 PYTHONPATH=$PYTHONPATH:/mnt/slurm/lennart/jepaslt/src python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ckplus_split_0_16x8x3.yaml --devices cuda:0 cuda:1 cuda:2
CUDA_VISIBLE_DEVICES=0,1,2 PYTHONPATH=$PYTHONPATH:/mnt/slurm/lennart/jepaslt/src python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ckplus_split_0_16x8x3.yaml --devices cuda:0 cuda:1 cuda:2
CUDA_VISIBLE_DEVICES=0,1,2 PYTHONPATH=$PYTHONPATH:/mnt/slurm/lennart/jepaslt/src python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ckplus_split_0_16x8x3.yaml --devices cuda:0 cuda:1 cuda:2
CUDA_VISIBLE_DEVICES=0,1,2 PYTHONPATH=$PYTHONPATH:/mnt/slurm/lennart/jepaslt/src python -m evals.main --fname=/mnt/slurm/lennart/jepaslt/configs/evals/vith16_384_ckplus_split_0_16x8x3.yaml --devices cuda:0 cuda:1 cuda:2
